...
function output(input1, check1, input2, check2) {
    ...
    let num1; //converts input1.value into denary
    switch (check1) {
        case "binary":
            num1 = bin2Denary(input1.value)
            break;
        case "denary":
            num1 = input1.value
            break;
        case "hexadecimal":
            num1 = hex2Denary(input1.value)
            break;
    }
    ...
    switch (check2) {
        case "binary":
            num2 = bin2Denary(input2.value)
            break;
        case "denary":
            num2 = input2.value
            break;
        case "hexadecimal":
            num2 = hex2Denary(input2.value)
            break;
        case "none":
            num2 = 0
            break;
